    ...
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/netherlands/netherlands-visit-visa.webp"
            alt="Netherlands visit visa from Qatar with Amsterdam canal tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for Netherlands Schengen tourist visa
              requirements, document preparation, travel itinerary, hotel
              booking, insurance, and visa application guidance from Doha.
            </p>
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for Netherlands Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your Netherlands Schengen tourist visa file correctly before
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <h3 className="mt-5 text-2xl font-bold md:text-3xl">
                  Need help preparing your Netherlands visa file?
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-300">
                  Our team can help you review documents, prepare travel plans,
                  organize supporting papers, and guide you through the
                  Netherlands visit visa process from Qatar.
                </p>
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image 
                src="/images/visit/netherlands/kinderdijk-windmills-netherlands-tourism.webp"
                alt="Amsterdam canals Netherlands tourism place for visit visa travellers"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Amsterdam is one of Europe’s most beautiful city destinations,
                known for historic canals, charming bridges, museums, cycling
                culture, and scenic Dutch architecture.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 text-3xl font-bold md:text-5xl">
              Most Visited Places in Netherlands
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-600">
              The Netherlands is popular for canals, tulip gardens, museums,
              windmills, peaceful villages, cycling routes, and beautiful
              European city experiences.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for Netherlands Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your Netherlands Schengen tourist visa application with
