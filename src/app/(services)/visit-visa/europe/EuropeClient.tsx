...
export default function EuropeClient() {
  return (
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/europe/europe-visit-visa.webp"
            alt="Europe visit visa from Qatar with Schengen tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white backdrop-blur">
              ...
              Tourist & Schengen Visa Assistance
            </span>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for Europe and Schengen tourist visa
              requirements, document preparation, travel itinerary, hotel
              booking, travel insurance, and visa application guidance from
              Doha.
            </p>
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for Europe Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your Europe or Schengen tourist visa file correctly before
            submission. WMIBC assists Qatar residents, Bangladeshi applicants,
            and GCC residents with complete document checking and application
            support.
          </p>
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <h3 className="mt-5 text-2xl font-bold md:text-3xl">
                  Need help preparing your Europe visa file?
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-300">
                  Our team can help you review documents, prepare travel plans,
                  organize supporting papers, and guide you through the Europe
                  or Schengen visit visa process from Qatar.
                </p>
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image
                src="/images/visit/europe/hallstatt-austria-lake-village-europe-tourist.webp"
                alt="Hallstatt Austria lake village tourism place for Europe Schengen visa travellers"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                One of Europe’s most picturesque alpine destinations known for
                beautiful lake views, charming mountain villages, historic
                churches, and unforgettable tourism experiences in Austria.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Europe is popular for historic cities, romantic destinations,
              museums, mountain landscapes, cultural landmarks, shopping, and
              unforgettable Schengen travel experiences.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for Europe Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your Europe or Schengen tourist visa application with
                proper document guidance and professional support.
              </p>
            </div>
