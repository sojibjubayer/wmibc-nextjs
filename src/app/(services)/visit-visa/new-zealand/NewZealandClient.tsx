    ...
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/new-zealand/new-zealand-visit-visa.webp"
            alt="New Zealand visit visa from Qatar with mountain and lake tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for New Zealand tourist visa
              requirements, document preparation, travel itinerary, hotel
              booking, and visa application guidance from Doha.
            </p>
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for New Zealand Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your New Zealand tourist visa file correctly before
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <h3 className="mt-5 text-2xl font-bold md:text-3xl">
                  Need help preparing your New Zealand visa file?
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-300">
                  Our team can help you review documents, prepare travel plans,
                  organize supporting papers, and guide you through the New
                  Zealand visit visa process from Qatar.
                </p>
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image
                src="/images/visit/new-zealand/queenstown-lake-wakatipu-new-zealand-tourism.webp"
                alt="Queenstown Lake Wakatipu New Zealand tourism destination with mountain landscape"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Queenstown is one of New Zealand’s most famous travel destinations known for alpine mountains, crystal-clear lakes,
                scenic landscapes, adventure tourism, and peaceful nature experiences.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 text-3xl font-bold md:text-5xl">
              Most Visited Places in New Zealand
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-600">
              New Zealand is popular for mountains, lakes, fjords, adventure
              tourism, scenic road trips, cultural experiences, and family
              friendly holidays.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for New Zealand Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your New Zealand tourist visa application with proper
                document guidance and professional support.
              </p>
            </div>
