...
export default function AustraliaClient() {
  return (
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/australia/australia-visit-visa.webp"
            alt="Australia visit visa from Qatar with Sydney tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for Australia tourist visa requirements,
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for Australia Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your Australia tourist visa file correctly before
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image
                src="/images/visit/australia/twelve-apostles-great-ocean-road-australia.webp"
                alt="Twelve Apostles Great Ocean Road Australia tourism place for visit visa travellers"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                One of Australia’s most scenic coastal attractions known for
                dramatic limestone cliffs, turquoise ocean views, golden
                beaches, and unforgettable road trip tourism experiences.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Australia is popular for modern cities, beaches, wildlife,
              mountain landscapes, coastal tourism, and unforgettable travel
              experiences.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for Australia Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your Australia tourist visa application with proper
