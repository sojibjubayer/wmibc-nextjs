    ...
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/turkey/turkey-visit-visa.webp" 
            alt="Turkey visit visa from Qatar with Istanbul tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for Turkey tourist visa requirements,
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for Turkey Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your Turkey tourist visa file correctly before submission.
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <h3 className="mt-5 text-2xl font-bold md:text-3xl">
                  Need help preparing your Turkey visa file?
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-300">
                  Our team can help you review documents, prepare travel plans,
                  organize supporting papers, and guide you through the Turkey
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image
                src="/images/visit/turkey/camlica-mosque-istanbul-turkey-tourism.webp"
                alt="Camlica Mosque Istanbul Turkey tourism destination with lake and autumn landscape"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Camlica Mosque is one of Istanbul’s most beautiful landmarks known for grand Ottoman architecture, peaceful surroundings,
                scenic city views, and cultural tourism experiences in Turkey. 
              </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Turkey is popular for historical landmarks, vibrant bazaars,
              beaches, mosques, scenic landscapes, cultural experiences, and
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for Turkey Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your Turkey tourist visa application with proper document
