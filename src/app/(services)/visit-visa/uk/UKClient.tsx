    ...
    <main className="bg-white text-slate-950">
      <section className="relative overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <Image
            src="/images/visit/uk/uk-visit-visa.webp"
            alt="UK visit visa from Qatar with London tourism view"
            fill
            priority
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              Get professional support for UK tourist visa requirements,
      ...
      >
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold leading-tight md:text-5xl">
            Required Documents for UK Visit Visa from Qatar
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Prepare your UK tourist visa file correctly before submission. WMIBC
            assists Qatar residents, Bangladeshi applicants, and GCC residents
            with complete document checking and application support.
          </p>
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <h3 className="mt-5 text-2xl font-bold md:text-3xl">
                  Need help preparing your UK visa file?
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-300">
                  Our team can help you review documents, prepare travel plans,
                  organize supporting papers, and guide you through the UK visit
                  visa process from Qatar.
                </p>
        ...
        <div className="lg:pt-16">
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
            <div className="relative aspect-4/5">
              <Image
                src="/images/visit/uk/buckingham-palace-london-uk.webp"
                alt="Buckingham Palace London United Kingdom tourism place for visit visa travellers"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                One of the United Kingdom’s most iconic royal landmarks known
                for historic architecture, the Victoria Memorial, ceremonial
                events, and world-famous tourism experiences in central London.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm">
              ...
              UK Travel Highlights
            </div>

            <h2 className="mt-5 text-3xl font-bold md:text-5xl">
              Most Visited Places in the United Kingdom
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-600">
              The United Kingdom is popular for historic landmarks, modern
              cities, royal attractions, shopping destinations, museums, and
              scenic countryside tourism experiences.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold md:text-4xl">
                Apply for UK Visit Visa from Doha
              </h2>

              <p className="mt-4 max-w-2xl text-slate-300">
                Start your UK tourist visa application with proper document
