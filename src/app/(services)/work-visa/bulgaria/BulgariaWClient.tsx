...
const visaInfo = [
  { title: "Visa Type", value: "Bulgaria Work Permit Visa" },
  { title: "Main Category", value: "Hospitality, Construction & Warehouse" },
  { title: "Available Roles", value: "Helper & General Worker" },
...
const processSteps = [
  {
    ...
    desc: "We review your passport, Qatar residence status, work experience, and eligibility for Bulgaria work permit visa processing.",
    icon: Users2,
  },
  {
    title: "Category Selection",
    desc: "Choose suitable Bulgaria work categories such as hospitality, construction, warehouse, packing helper, or general helper.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Document Preparation",
    desc: "Get support for Bulgaria work permit checklist, application guidance, document preparation, and employer file readiness.",
    icon: FileCheck2,
  },
  {
    title: "Visa Processing Support",
    desc: "Step-by-step guidance for Bulgaria work permit visa processing, documentation, application readiness, and updates.",
    icon: ShieldCheck,
  },
];

const highlights = [
  "Bulgaria work permit visa support from Qatar",
  "Hospitality, construction and warehouse categories",
  "Helper and general worker visa guidance",
  "Professional consultation before starting the process",
];

const faqs = [
  {
    q: "Can I apply for Bulgaria work permit visa from Qatar?",
  ...
  {
    q: "Which job categories are available for Bulgaria?",
    a: "Common categories include hospitality worker, hotel helper, restaurant helper, housekeeping staff, construction worker, warehouse worker, packing helper, and general helper.",
  },
  {
    q: "What documents are required for Bulgaria work permit visa?",
  ...
  {
    q: "Does WMIBC guarantee Bulgaria visa approval?",
  ...
  {
    q: "How long does Bulgaria work permit visa processing take?",
...
export default function BulgariaWClient() {
    ...
    <main className="overflow-x-hidden bg-slate-50 text-slate-900 antialiased">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white shadow-2xl lg:rounded-[3rem]">
            ...
            <div className="relative h-64 sm:h-80 lg:absolute lg:inset-0 lg:h-full lg:w-full">
              <Image
                src="/images/work/bulgaria-work-permit-visa-processing.webp"
              ...
              <div>
                <div className="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-slate-200 bg-white/85 px-4 py-2 text-xs font-semibold text-blue-900 shadow-sm backdrop-blur-md sm:text-sm">
                  ...
                  <span className="truncate">
                    Bulgaria Work Visa from Qatar
                  </span>
                </div>

                <h1 className="text-3xl font-black leading-[1.1] tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl">
                  Bulgaria Work Permit <br className="hidden sm:block" />
                  <span className="text-blue-600">Visa Processing</span>
                </h1>

                <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
                  Apply for Bulgaria work permit visa from Qatar with
                  professional support for hospitality, construction, warehouse,
                  packing, and helper categories.
                </p>
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8">
          {[
            { icon: BadgeCheck, text: "Bulgaria work permit guidance" },
            { icon: Building2, text: "Multiple job category support" },
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mb-12 text-center lg:text-left">
            <h2 className="text-3xl font-black text-slate-900 sm:text-4xl">
              Bulgaria Job Categories
            </h2>
            <p className="mt-4 text-slate-600">
              Popular Bulgaria work permit categories for Qatar-based
              applicants.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {jobCategories.map((job) => (
              ...
              >
                ...
                <span className="text-sm font-bold text-slate-900">{job}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              title: "Hospitality",
              desc: "Support for hotel helpers, restaurant helpers, housekeeping staff, and general hospitality workers.",
              icon: Hotel,
            },
            {
              title: "Construction",
              desc: "Support for construction workers, site helpers, general helpers, and labor-related work categories.",
              icon: Hammer,
            },
            {
              title: "Warehouse",
              desc: "Support for warehouse workers, packing helpers, loading helpers, and general warehouse staff.",
              icon: PackageCheck,
            },
          ].map((item) => (
            <div
          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">
                Bulgaria work permit visa checklist
              </h2>

              <p className="mt-4 text-sm leading-7 text-slate-600">
                Common documents for Bulgaria work permit visa processing.
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] border border-blue-100 bg-linear-to-br from-white via-blue-50 to-cyan-50 p-8 shadow-xl shadow-blue-100/60 sm:p-12 lg:p-16">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-white/80 px-4 py-2 text-xs font-bold uppercase tracking-wide text-blue-600 shadow-sm">
                ...
                Bulgaria Work Permit Support
              </div>

              <h2 className="max-w-2xl text-3xl font-black leading-tight tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
                Start your Bulgaria work visa journey with confidence.
              </h2>

              <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Get professional consultation and document review for Bulgaria
                hospitality, construction, warehouse, and helper categories from
                Qatar.
              </p>
