...
const visaInfo = [
  { title: "Visa Type", value: "Canada Work Permit Visa" },
  { title: "Processing From", value: "Qatar" },
  {
    title: "Available Sectors",
    value: "Warehouse, Hospitality, Construction & General Work",
  },
...
const processSteps = [
  {
    ...
    desc: "We review your profile, work experience, passport details, residence status, and eligibility for Canada work permit visa processing.",
    icon: Users2,
  },
  {
    title: "Job Category Selection",
    desc: "Choose suitable Canada job categories based on available positions and your profile.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Document Preparation",
    desc: "Get support for Canada work visa checklist, application form guidance, work permit file preparation, and required documents.",
    icon: FileCheck2,
  },
  {
    title: "Application Support",
    desc: "Step-by-step support for Canada work permit, document checking, application readiness, and process updates from our team.",
    icon: ShieldCheck,
  },
];

const highlights = [
  "Canada work permit visa support from Qatar",
  "Support for Qatar, GCC and Bangladesh applicants",
  "Multiple job sector opportunities",
  "Complete document checking and application guidance",
];

const faqs = [
  {
    q: "How can I apply for a Canada work permit from Qatar?",
    a: "You can start by checking your profile, job category, passport validity, residence status, and document readiness. WMIBC provides guidance for Canada work permit visa processing from Qatar.",
  },
  {
    q: "What jobs are available for Canada work visa applicants?",
    a: "Available Canada work visa job categories may include warehouse worker, factory worker, cleaner, kitchen helper, construction worker, hospitality staff, and other general positions depending on employer availability.",
  },
  {
    q: "What documents are required for Canada work visa?",
  ...
  {
    q: "How long does Canada work permit visa processing take?",
  ...
  },
  {
    ...
    a: "Yes. WMIBC assists Qatar residents, GCC-based applicants, and Bangladeshi applicants depending on profile, documents, job category, employer file, and current Canada work permit availability. Processing coordination is handled from Qatar, with additional support available through our Bangladesh office.",
  },
];

export default function CanadaWClient() {
            ...
            <div className="relative z-10 grid gap-8 p-5 sm:p-8 md:p-10 lg:grid-cols-[1fr_380px] lg:items-center lg:p-16 xl:grid-cols-[1fr_440px]">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-(--text-body) sm:mt-6 sm:text-lg">
                  Apply for Canada work permit visa with WMIBC. We assist
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-24">
        <header className="mb-10 max-w-3xl lg:mb-12">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-(--text-body) sm:text-base">
            WMIBC provides Canada work permit visa guidance for Qatar
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-10 text-center lg:mb-12 lg:text-left">
            ...
            <p className="mt-4 text-sm text-(--text-body) sm:text-base">
              Popular Canada work permit job categories for applicants from
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-12">
          <div>
            ...
            <p className="mt-4 text-sm leading-7 text-(--text-body)">
              Common documents for Canada work permit visa processing.
              Final requirements may vary by employer, embassy, visa center,
              job category, and applicant location.
            </p>
