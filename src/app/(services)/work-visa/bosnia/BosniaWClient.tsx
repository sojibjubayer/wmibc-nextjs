...
const visaInfo = [
  { title: "Visa Type", value: "Bosnia Work Permit Visa" },
  { title: "Processing From", value: "Qatar" },
  {
    title: "Available Sectors",
    value: "General Worker, Factory, Warehouse, Construction",
  },
  {
...
const processSteps = [
  {
    ...
    desc: "We review your profile, work experience, passport details, residence status, and eligibility for Bosnia work permit visa processing.",
    icon: Users2,
  },
  {
    title: "Job Category Selection",
    desc: "Choose suitable Bosnia job categories such as general worker, factory worker, warehouse worker, or construction helper.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Document Preparation",
    desc: "Get support for Bosnia work visa checklist, application form guidance, work permit file preparation, and required documents.",
    icon: FileCheck2,
  },
  {
    title: "Application Support",
    desc: "Step-by-step support for Bosnia work permit, document checking, application readiness, and process updates from our team.",
    icon: ShieldCheck,
  },
];

const highlights = [
  "Bosnia work permit visa support from Qatar",
  "Support for Qatar, GCC and Bangladesh applicants",
  "General worker, factory and warehouse sectors",
  "Complete document checking and application guidance",
];

const faqs = [
  {
    q: "How can I apply for a Bosnia work permit from Qatar?",
    a: "You can start by checking your profile, job category, passport validity, residence status, and document readiness. WMIBC provides guidance for Bosnia work permit visa processing from Qatar.",
  },
  {
    q: "What jobs are available for Bosnia work visa applicants?",
    a: "Common Bosnia work visa job categories include general worker, factory worker, warehouse worker, and construction helper.",
  },
  {
    q: "What documents are required for Bosnia work visa?",
  ...
  {
    q: "How long does Bosnia work permit visa processing take?",
  ...
  },
  {
    ...
    a: "Yes. WMIBC assists Qatar residents, GCC-based applicants, and Bangladeshi applicants depending on profile, documents, job category, employer file, and current Bosnia work permit availability. Processing coordination is handled from Qatar, with additional support available through our Bangladesh office.",
  },
];

export default function BosniaWClient() {
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-4xl border border-(--border-soft) bg-white shadow-2xl sm:rounded-[2.5rem] lg:rounded-[3rem]">
            <div className="relative h-72 sm:h-96 lg:absolute lg:inset-0 lg:h-full lg:w-full">
              <Image
                src="/images/work/bosnia-work-permit-visa-qatar.webp"
                alt="Bosnia work permit visa processing support from Qatar for GCC and Bangladesh applicants"
                fill
                priority
                sizes="100vw"
              ...
              <div>
                <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-white/60 bg-white/90 px-4 py-2 text-[11px] font-semibold text-(--brand-navy) shadow-sm backdrop-blur-md sm:text-sm">
                  ...
                  <span className="truncate">
                    Bosnia Work Permit Visa from Qatar
                  </span>
                </div>

                <h1 className="text-3xl font-black leading-[1.08] tracking-tight text-(--text-heading) sm:text-5xl md:text-5xl">
                  Bosnia Work Permit <br className="hidden sm:block" />
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-(--text-body) sm:mt-6 sm:text-lg">
                  Apply for Bosnia work permit visa with WMIBC. We assist Qatar
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-24">
        <header className="mb-10 max-w-3xl lg:mb-12">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-(--text-body) sm:text-base">
            WMIBC provides Bosnia work permit visa guidance for Qatar residents,
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-10">
            <div>
              <h2 className="text-3xl font-black text-white sm:text-5xl">
                Start your Bosnia journey today.
              </h2>
