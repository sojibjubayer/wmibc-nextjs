...
const visaInfo = [
  { title: "Visa Type", value: "North Macedonia Work Permit Visa" },
  { title: "Processing From", value: "Qatar" },
  {
    title: "Available Sectors",
    value: "Factory, Warehouse, Construction, Hospitality, Agriculture",
  },
  {
...
const processSteps = [
  {
    ...
    desc: "We review your profile, work experience, passport details, residence status, and eligibility for North Macedonia work permit visa processing.",
    icon: Users2,
  },
  {
    title: "Job Category Selection",
    desc: "Choose suitable North Macedonia job categories such as factory worker, warehouse worker, construction worker, hotel staff, cleaner, kitchen helper, agricultural worker, or packaging worker.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Document Preparation",
    desc: "Get support for North Macedonia work visa checklist, application form guidance, work permit file preparation, and required documents.",
    icon: FileCheck2,
  },
  {
    title: "Application Support",
    desc: "Step-by-step support for North Macedonia work permit, document checking, application readiness, and process updates from our team.",
    icon: ShieldCheck,
  },
];

const highlights = [
  "North Macedonia work permit visa support from Qatar",
  "Support for Qatar, GCC and Bangladesh applicants",
  "Factory, warehouse, construction and hospitality sectors",
  "Complete document checking and application guidance",
];

const faqs = [
  {
    q: "How can I apply for a North Macedonia work permit from Qatar?",
    a: "You can start by checking your profile, job category, passport validity, residence status, and document readiness. WMIBC provides guidance for North Macedonia work permit visa processing from Qatar.",
  },
  {
    q: "What jobs are available for North Macedonia work visa applicants?",
    a: "Common worker-type job categories include factory worker, warehouse worker, construction worker, hotel staff, cleaner, kitchen helper, agricultural worker, and packaging worker.",
  },
  {
    q: "What documents are required for North Macedonia work visa?",
  ...
  {
    q: "How long does North Macedonia work permit visa processing take?",
  ...
  },
  {
    ...
    a: "Yes. WMIBC assists Qatar residents, GCC-based applicants, and Bangladeshi applicants depending on profile, documents, job category, employer file, and current North Macedonia work permit availability. Processing coordination is handled from Qatar, with additional support available through our Bangladesh office.",
  },
];

export default function NorthMacedoniaWClient() {
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-4xl border border-(--border-soft) bg-white shadow-2xl sm:rounded-[2.5rem] lg:rounded-[3rem]">
            <div className="relative h-72 sm:h-96 lg:absolute lg:inset-0 lg:h-full lg:w-full">
              <Image
                src="/images/work/north-macedonia-work-permit-visa-qatar.webp"
                alt="North Macedonia work permit visa processing support from Qatar for GCC and Bangladesh applicants"
                fill
                priority
                sizes="100vw"
            ...
            <div className="relative z-10 grid gap-8 p-5 sm:p-8 md:p-10 lg:grid-cols-[1fr_380px] lg:items-center lg:p-16 xl:grid-cols-[1fr_440px]">
              <div>
                ...
                <h1 className="text-3xl font-black leading-[1.08] tracking-tight text-(--text-heading) sm:text-5xl md:text-6xl lg:text-6xl">
                  North Macedonia Work Permit <br className="hidden sm:block" />
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-(--text-body) sm:mt-6 sm:text-lg">
                  Apply for North Macedonia work permit visa with WMIBC. We
                  assist Qatar residents, GCC-based applicants, and Bangladeshi
                ...
                <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:items-center lg:mt-10">
                  ...
                  >
                    Apply for North Macedonia Work Permit
                  </Link>
                ...
                <div className="mb-5 flex items-center gap-4 sm:mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-(--text-muted)">
                      North Macedonia work visa sectors
                    </p>
                  </div>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-24">
        <header className="mb-10 max-w-3xl lg:mb-12">
          <div className="mb-4 inline-flex rounded-full bg-(--bg-soft-blue) px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-(--brand-royal)">
            North Macedonia Work Permit Details
          </div>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-(--text-body) sm:text-base">
            WMIBC provides North Macedonia work permit visa guidance for Qatar
            residents, GCC-based applicants, and Bangladeshi applicants with
            document checking and application preparation support.
          </p>
        </header>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-10 text-center lg:mb-12 lg:text-left">
            ...
            <p className="mt-4 text-sm text-(--text-body) sm:text-base">
              Popular North Macedonia work permit job categories for applicants
              from Qatar, GCC countries, and Bangladesh.
            </p>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-12">
          <div>
            ...
            <h2 className="text-3xl font-black tracking-tight text-(--text-heading) sm:text-4xl">
              North Macedonia work visa checklist
            </h2>

            <p className="mt-4 text-sm leading-7 text-(--text-body)">
              Common documents for North Macedonia work permit visa processing.
              Final requirements may vary by employer, embassy, visa center, job
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-10">
            <div>
              <h2 className="text-3xl font-black text-white sm:text-5xl">
                Start your North Macedonia journey today.
              </h2>
