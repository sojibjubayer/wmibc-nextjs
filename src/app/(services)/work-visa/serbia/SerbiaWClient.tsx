...
const visaInfo = [
  { title: "Visa Type", value: "Serbia Work Permit Visa" },
  { title: "Processing From", value: "Qatar" },
  {
    title: "Available Sectors",
    value: "Construction, Cleaning, Warehouse, Tile Mason",
  },
  {
...
const processSteps = [
  {
    ...
    desc: "We review your profile, work experience, passport details, residence status, and eligibility for Serbia work permit visa processing.",
    icon: Users2,
  },
  {
    title: "Job Category Selection",
    desc: "Choose suitable Serbia job categories such as construction worker, cleaner, warehouse worker, or tile mason.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Document Preparation",
    desc: "Get support for Serbia work visa checklist, application form guidance, work permit file preparation, and required documents.",
    icon: FileCheck2,
  },
  {
    title: "Application Support",
    desc: "Step-by-step support for Serbia work permit, document checking, application readiness, and process updates from our team.",
    icon: ShieldCheck,
  },
];

const highlights = [
  "Serbia work permit visa support from Qatar",
  "Support for Qatar, GCC and Bangladesh applicants",
  "Construction, cleaning, warehouse and tile mason sectors",
  "Complete document checking and application guidance",
];

const faqs = [
  {
    q: "How can I apply for a Serbia work permit from Qatar?",
    a: "You can start by checking your profile, job category, passport validity, residence status, and document readiness. WMIBC provides guidance for Serbia work permit visa processing from Qatar.",
  },
  {
    q: "What jobs are available for Serbia work visa applicants?",
    a: "Common Serbia work visa job categories include construction worker, cleaner, warehouse worker, and tile mason.",
  },
  {
    q: "What documents are required for Serbia work visa?",
  ...
  {
    q: "How long does Serbia work permit visa processing take?",
  ...
  },
  {
    ...
    a: "Yes. WMIBC assists Qatar residents, GCC-based applicants, and Bangladeshi applicants depending on profile, documents, job category, employer file, and current Serbia work permit availability. Processing coordination is handled from Qatar, with additional support available through our Bangladesh office.",
  },
];

export default function SerbiaWClient() {
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-4xl border border-(--border-soft) bg-white shadow-2xl sm:rounded-[2.5rem] lg:rounded-[3rem]">
            <div className="relative h-72 sm:h-96 lg:absolute lg:inset-0 lg:h-full lg:w-full">
              <Image
                src="/images/work/serbia-work-permit-visa-qatar.webp"
                alt="Serbia work permit visa processing support from Qatar for GCC and Bangladesh applicants"
                fill 
                priority 
                sizes="100vw"
            ...
            <div className="relative z-10 grid gap-8 p-5 sm:p-8 md:p-10 lg:grid-cols-[1fr_380px] lg:items-center lg:p-16 xl:grid-cols-[1fr_440px]">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-(--text-body) sm:mt-6 sm:text-lg">
                  Apply for Serbia work permit visa with WMIBC. We assist Qatar
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-24">
        <header className="mb-10 max-w-3xl lg:mb-12">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-(--text-body) sm:text-base">
            WMIBC provides Serbia work permit visa guidance for Qatar residents,
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-10 text-center lg:mb-12 lg:text-left">
            ...
            <p className="mt-4 text-sm text-(--text-body) sm:text-base">
              Popular Serbia work permit job categories for applicants from
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-12">
          <div>
            ...
            <h2 className="text-3xl font-black tracking-tight text-(--text-heading) sm:text-4xl">
              Serbia work visa checklist
            </h2>

            <p className="mt-4 text-sm leading-7 text-(--text-body)">
              Common documents for Serbia work permit visa processing. Final
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-10">
            <div>
              <h2 className="text-3xl font-black text-white sm:text-5xl">
                Start your Serbia journey today.
              </h2>
